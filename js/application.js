 ...
 * Parse URL params.
 */
var regex = /[?]([^=#]+)/g, url = window.location.href, $_GET = [], match;
...
if (currentPattern !== null) {
	...
	var errorMessage = "<div class=\"error\">Unknown pattern should be loaded. Please add \"?\{PATTERN_NAME\}\" parameter to page URL.<br><br>Available values: <ul>";
	for (var j = 0; j < PATTERN_VALUES.length; j++) {
		errorMessage += "<li><a href=\"?" + PATTERN_VALUES[j] + "\">"
				+ PATTERN_VALUES[j] + "</a></li>";
	}
	errorMessage += "</ul></div>";
